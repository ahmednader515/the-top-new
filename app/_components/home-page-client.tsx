          ...
          >
            ...
            <div className="flex flex-col items-center gap-2 md:gap-6 lg:gap-8 w-full mb-0 pb-0 -mb-2 md:mb-0">
              ...
              <Button asChild className="bg-gray-900 hover:bg-gray-800 text-white text-base md:text-xl px-4 md:px-8 py-3 md:py-4 h-auto w-[95vw] sm:w-64 md:w-80 lg:w-96 mb-0">
                <Link
                  href="https://download2289.mediafire.com/4xwbxvmhylrgFW2Ky-0fWn9Y_pvhyuyHs5Cmzo-qxe4bu14nYJaFOboeKfEw1ASwzMFfpW747ntWo5d0YilZSJlpasc2GOggdbKcapIEa5C2SEinMsHcL2GEDSU0lOgSff3BAJv_W2yGAYgSdQP_bbmws4lfNLcDA3IdM_wAiLTukA/tmmzb8imjktk1v3/theTop.apk"
                  target="_blank"
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                ...
                <Button asChild className="w-full bg-brand hover:bg-brand/90 text-white">
                  <Link href="/sign-up?curriculum=عربي">ابدأ مع المنهج العربي</Link>
                </Button>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <Button asChild className="w-full bg-brand hover:bg-brand/90 text-white">
                  <Link href="/sign-up?curriculum=لغات">ابدأ مع منهج اللغات</Link>
                </Button>
              </div>
            </motion.div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <p className="text-muted-foreground">&ldquo;{testimonial.testimonial}&rdquo;</p>
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground">
                انضم إلى مجتمع من الطلاب النشطين والمتفوقين والأوائل
              </p>
            </motion.div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">انضم إلينا اليوم وابدأ رحلة النجاح</p>
